...
const About = () => {
    return (
        <section id="about" class="">
            <main className="h-100vh p-8 lg:m-20 rounded-md shadow-[0_2px_10px_2px_rgba(0,0,0,0.1)] flex flex-col lg:flex-row justify-between items-center">
                <div className="lg:w-1/3 flex flex-col justify-start items-center ">
                    ...
                    <div className="flex flex-col gap-2 justify-start items-start text-slate-700">
                ...
                <div className="lg:w-3/4 text-xl text-justify text-slate-700">
                    <h4 className="text-left text-3xl pb-2 text-black  font-bold">About me</h4>
