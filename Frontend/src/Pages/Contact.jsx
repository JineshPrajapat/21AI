...
const Contact = () => {
    return (
        <section id="contact" className="contact section py-20 lg:px-20">
            ...
            <div className="container mx-auto px-3" data-aos="fade-up" data-aos-delay="100">
                <div className="bg-white shadow-[0_2px_10px_2px_rgba(0,0,0,0.1)] rounded-lg p-8 mb-8" data-aos="fade-up" data-aos-delay="200">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {contactInfo.map((info, index) => (
                            <div key={index} className="flex gap-4 items-center text-left">
                ...
                <form
                    className="bg-white shadow-[0_2px_10px_2px_rgba(0,0,0,0.1)] rounded-lg md:p-8 py-8 px-5"
                    data-aos="fade-up"
                    data-aos-delay="300"
                >
                    <div className="flex flex-col md:grid md:grid-cols-2 gap-6">
                            <input
                                type="text"
                                name="name"
                                className="form-control w-full p-3 bg-slate-50 border border-gray-300 rounded focus:border-blue-500"
