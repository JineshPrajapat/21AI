        ...
        <section id="services" className="services section py-12 px-3 lg:px-20 bg-gray-50 dark:bg-gray-900">
            ...
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-left">
                {servicesData.map((service, index) => (
                    <div
                        key={index}
                        className="relative bg-white dark:bg-gray-800 rounded-lg p-8 shadow-lg transition transform duration-500 hover:-translate-y-2 hover:border-blue-600 border-b-4 border-transparent"
                    >
